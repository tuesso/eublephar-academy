const CACHE="eublephar-v5.3-alan-hector";
const ASSETS=["./","./index.html","./styles-v5.css","./app-v5.js","./alan-hector.css","./alan-hector.js","./manifest.webmanifest","./gecko-real.webp","./icon-192.png","./icon-512.png"];
